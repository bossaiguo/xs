...
class client {
	 ...
	 * 手机用户登陆
	 */
	public function ps_mobile_login($username) {
		$return = $this->_ps_send('mobile_login', array('username'=>$username));
		return $return;
	}
...
EOF;
	...
	*/
	...
	public function auth_data($data) {
		...
		$auth_s = 'v='.$this->ps_vsersion.'&appid=1&data='.urlencode($this->sys_auth($s));
		return $auth_s;
	}
